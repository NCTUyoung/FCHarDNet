...
def demo(cfg,pkg_root,img_sub,drive_pub,drive_pred_pub,drive_pred_lane_pub,drive_pred_max):
     # Setup device
...
if __name__ == "__main__":
    ...
    demo(cfg,pkg_root,img_sub,drive_pub,drive_pred_pub,drive_pred_lane_pub,drive_pred_max)
